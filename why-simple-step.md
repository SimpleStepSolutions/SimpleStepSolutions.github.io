    ...
    <div class="col-md-6 d-flex">
        <div class="card card-danger flex-fill">
            <div class="card-block">
                ...
                <div class="card-text">
                    <ul>
                        <li>We specialize in <b>security best-practices</b> regarding architecture and <b>Identity and Access Management (IAM)</b>--including service-to-service communication, internal and external facing APIs, and Single Sign-on <br/><small>(OAuth2, OpenID Connect)</small></li>
